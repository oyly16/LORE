...
# use local model
flux_path = "/data/RF-Solver-Edit/src/flux/FLUX.1-dev"
flux_ckpt_path = "/data/RF-Solver-Edit/src/flux/FLUX.1-dev/flux1-dev.safetensors"
flux_ae_path = "/data/RF-Solver-Edit/src/flux/FLUX.1-dev/ae.safetensors"
t5_path = "/data/RF-Solver-Edit/src/flux/t5-v1_1-xxl"
clip_path = "/data/RF-Solver-Edit/src/flux/clip-vit-large-patch14"
...
configs = {
    ...
    "flux-schnell": ModelSpec(
        repo_id="/data/RF-Solver-Edit/src/flux/FLUX.1-schnell",
